...
const Example = ({ data, filePath }: ExampleProps) => {
            ...
            <React.Fragment key={index}>
              ...
              {item.sectionType === 'image' && (
                <Image
                  ...
                  alt={`Example Image - /${filePath}${item.file}`}
                  key={`image-${index}`}
